...
<img src="UploadCertificate.png" alt="Upload Certificate">
...
11.	In the Add a client secret window, enter a description, select an expires value, and select Add
 ...
 <img src="AddSecret.png" alt="Add client secret">

12.	You must copy the Value for the client secret as it will never be visible again.

 <img src="ClientSecret.png" alt="Client secret">
...
<img src="ConfiguredPermissions.png" alt="Configured Permissions">
